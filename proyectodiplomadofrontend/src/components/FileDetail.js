    ...
    useEffect(() => {
        const fetchFileDetails = async () => {
            if (hash) {
                try {
                    // Fetch file details
                    const fileResponse = await fetch(`/files/${hash}`);
                    ...
                    const ownerResponse = await fetch(`/file/${hash}/owner`, {
                        headers: {
                    ...
                    const signatureResponse = await fetch(`/verify-signature`, {
                        method: 'POST',
                        headers: {
